...
DB_SERVER="${1:-${DB_SERVER:-devopsinssrv1.database.windows.net}}"
DB_NAME="${2:-${DB_NAME:-todoappdb}}"
DB_USER="${DB_USER:-devopsadmin}"
...
sudo -u devopsadmin env DB_SERVER="$DB_SERVER" DB_NAME="$DB_NAME" DB_USER="$DB_USER" DB_PASS="$DB_PASS" bash -lc '
cd /home/devopsadmin/
